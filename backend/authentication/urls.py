...
from .views import RegistrationView, LoginView, LogoutView, accept_friendship_invitation, check_unique, check_auth, get_friendship_invitations, reject_friendship_invitation, get_friendship_amis, send_friend_request
